/*
  # Исправление политик хранилища для аватаров пользователей

  1. Новые политики
    - Настройка корректных политик для работы с пользовательскими аватарами
    - Обеспечение публичного доступа на чтение
...
-- Обновляем публичный доступ для product-images
DO $$
BEGIN
  UPDATE storage.buckets
  SET public = true
