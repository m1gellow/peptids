/*
  # Добавление курсов обмена в таблицу payment_addresses

  1. Изменения
     - Добавлены поля для курсов обмена для всех типов платежей
     - Добавлен уникальный индекс по полю типа платежа
     - Добавлено поле name для удобства администрирования
  2. Безопасность
     - Сохранены существующие политики безопасности
*/
